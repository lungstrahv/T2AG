...
> 位置：`30_course_definitions/_shared/`。只登记跨课程可复用的在线资源和确需离线保存的共享文件。
> 分类、落位、登记字段的唯一规则见 `main/50_playbook/book_management.md`。
...
|---|---|---|---|---|---|---|---|---|---|
| ER001 | Cambridge Math Tripos Notes | 公开课 | `https://dec41.user.srcf.net/notes/` | MATH1607H, IV1001, 未来数学课程 | 数学分析、概率、统计、优化及相关数学主题 | 辅助解释、分级提示 | 在线读取 | Dexter Chua；公开免费，源码在 GitHub | 2026-07-13 |

## ER001 · Cambridge Math Tripos Notes
